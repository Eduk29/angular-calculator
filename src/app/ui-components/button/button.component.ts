...
export class ButtonComponent {
  ...
  public clickEventHandler: any = {
    number: () =>
      this.coreService.callNextOnNumberSubject(this.buttonConfiguration),
    operation: () =>
      this.coreService.callNextOnOperationSubject(this.buttonConfiguration),
    general: () =>
      this.coreService.callNextOnGeneralSubject(this.buttonConfiguration),
  };
