...
export class CoreComponent implements OnInit {
    ...
    private registerClickSubscriptions(): void {
        this.coreService.numberClickEvent$.subscribe((button: ButtonConfiguration) => {
            this.numberButtonClickEvent(button);
        });

        this.coreService.operationClickEvent$.subscribe((button: ButtonConfiguration) => {
            this.operationButtonClickEvent(button);
        });

        this.coreService.generalClickEvent$.subscribe((button: ButtonConfiguration) => {
